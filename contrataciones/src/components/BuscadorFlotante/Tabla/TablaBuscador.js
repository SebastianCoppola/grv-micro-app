...
const TablaBuscador = (props) => {
    ...
    const headerTablaBuscador = [
        {
            ...
            headerStyle: { color: '#747474' },
            render: (row) => {
                return (
                    row.prioritario === 1 ?
                        <div>
                            <Grid container alignItems="center" spacing={2} className={classes.espacio}>
                                <Grid item >
    ...
    const BorderColor = (data) => {
        ...
        //activo sin convenio
            ...
            && (data && data.prestadorMedicoDTO && (data.prestadorMedicoDTO.convenioActivo === 0
                || data.prestadorMedicoDTO.convenioActivo === null))) {
