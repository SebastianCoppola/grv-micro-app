  ...
  return dispatch => {
    ...
    //     cbSuccess(true)
        dispatch(setListadoTipoValorViajeNegativo([
          {codigo:1,descripcion:"Porcentual"},
          {codigo:2,descripcion:"Monto Fijo"}
        ]))
    //   }else{
    //     dispatch(setListadoTipoValorViajeNegativo([]))
    //     dispatch(setLoadingTipoValorViajeNegativo(false))
...
export const getListadoDestinoFrecuentes = (cbSuccess)=>{
  let data = [
    {
      "codigo": 1,
      "descripcion": "CENTRO MEDICO NOGOYA AVELLANEDA",
      "direccion": "Av. Hipólito Yrigoyen 688"
    },
    {
      "codigo": 2,
      "descripcion": "CENTRO MEDICO NOGOYA CABA",
      "direccion": "La Rioja 682"
    },
    {
      "codigo": 3,
      "descripcion": "CLINICA CIUDAD DE LA VIDA",
      "direccion": "La pampa 458"
    },
    {
      "codigo": 4,
      "descripcion": "CLINICA CIUDAD DE LA VIDA",
      "direccion": "La Rioja 4545"
    },
    {
      "codigo": 5,
      "descripcion": "CLINICA CIUDAD DE LA VIDA",
  ...
  return dispatch => {
    ...
    setTimeout(()=>{
      dispatch(setListadoDestinoFrecuente(data))
